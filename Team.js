            ...
            <div className='row p-5  mt-5  border-top'>
               ...
               <div className='row p-5  text-muted' style={{lineHeight:"1.8",fontSize:"1.1em"}}  >
                        <div className='col-6  p-5 text-center'>
                            <img src='media/images/Ankit.png' style={{borderRadius:"100%",width:"80%",height:"60%"}}/>
                            <h4 className='mt-4'> Ankit Jakhar</h4>
                            <h6> Founder, CEO</h6>
                        </div>

                        <div className='col-6 p-5'>
                    <p>
                        Ankit bootstrapped and founded Zerodha in 2026 to overcome
