            ...
            <div className='row p-5  mt-5 mb-5 '>
               ...
               <div className='row p-5  mt-5 border-top  text-muted' style={{lineHeight:"1.8",fontSize:"1.1em"}}  >
                <div className='col-6  p-5'>
                        ...
                        <p> Over 1.6+ crore clients place billions 
                            of orders every year through our powerful
                             ecosystem of investment platforms, contributing
                              over 15% of all Indian retail trading volumes.</p>
                </div>

                <div className='col-6 p-5'>
                    <p>In addition, we run a number of popular open online
                         educational and community initiatives to empower 
                         retail traders and investors.</p>
                    <p>
                    ...
                    <p>And yet, we are always up to something new every day. 
                        ...
                        the media is saying about us or learn more about our business
